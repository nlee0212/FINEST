...
def eval_single_response(question,response):
...
def eval_from_file():
    ...
    eval_file = os.path.join(args.evaluation_dir,args.evaluation_file)
    
    eval_df = get_error_score_eval_from_df(response_file,eval_file,args.id_col,args.question_col,args.response_col,"core_question","keywords",
                                           args.model_path,model,tokenizer,args.temperature,args.top_p,args.max_tokens,args.gpt_azure)
...
#     eval_single_response(question,response)
